...
class AppListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final titleStyle = SpitoutTextTokens.title(context)
        .copyWith(color: SpitoutTokens.textPrimary(context)); // ⭐ 使用 Token
      ...
      child: Row(
        children: [
          ...
          if (trailing != null)
            ...
            Icon(AppIcons.chevronRight, color: SpitoutTokens.iconTertiary(context)), // ⭐ 使用 Token
        ],
      ),
    );
